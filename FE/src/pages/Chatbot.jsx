...
const Chatbot = () => {
    ...
    return (
        <div className="h-screen bg-gradient-to-br from-blue-200 to-white flex flex-col items-center py-6 px-4">
            ...
            <div className="w-full max-w-3xl bg-white rounded-3xl shadow-xl p-6 overflow-y-auto max-h-[500px] scrollbar-thin scrollbar-thumb-blue-400 scrollbar-track-blue-100">
  ...
  __html: `
    <div class="flex items-start gap-2 ${msg.sender === "user" ? "justify-end" : "justify-start"}">
      <span class="font-bold text-lg">${msg.sender === "user" ? "👤 Bạn:" : "🤖 Bot:"}</span>
