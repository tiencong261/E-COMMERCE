...
const ShopContextProvider = (props) => {
    ...
    const [products, setProducts] = useState([]);
    const [token, setToken] = useState('');
    const [shownMissingProductWarning, setShownMissingProductWarning] = useState(false);
    ...
    useEffect(() => {
        ...
        if (hasMissingProduct && !shownMissingProductWarning) {
            toast.warn("Sản phẩm trong giỏ hàng của bạn hiện không còn tồn tại. Vui lòng chọn sản phẩm khác.");
